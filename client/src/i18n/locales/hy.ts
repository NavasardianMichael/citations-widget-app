...
export const hy = {
  ...
  'guestConflict.body':
    'Այս սարքում կան չպահպանված փոփոխություններ (պահված մեջբերումներ և/կամ վիջեթի կարգավորումներ), իսկ Ձեր հաշիվն արդեն ունի իր տվյալները։ Ընտրեք՝ որոնք պահել։',
  'guestConflict.keepLocal': 'Պահել այս սարքի փոփոխությունները',
  'guestConflict.keepLocalHint':
    'Կփոխարինի հաշվի կարգավորումները և կավելացնի այս սարքում պահված մեջբերումները։',
  'guestConflict.useRemote': 'Օգտագործել հաշվի տվյալները',
  'guestConflict.useRemoteHint': 'Այս սարքի չպահպանված փոփոխությունները կչեղարկվեն։',
