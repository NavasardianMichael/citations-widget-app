...
export const hy = {
  ...
  'guestConflict.title': 'Ո՞ր տվյալները պահել',
  'guestConflict.body':
    'Այս սարքում կան արդեն իսկ արված կարգավորումներ (պահված մեջբերումներ և/կամ վիջեթի կարգավորումներ), իսկ Ձեր օգտատիրոջ հաշվում պահպանված կարգավորումները կարող են տարբեվել: Ընտրեք՝ որոնք պահպանել մուտք գործած հաշվի վրա։',
  'guestConflict.keepLocal': 'Պահել այս սարքի փոփոխությունները',
  'guestConflict.keepLocalHint':
    'Կջնջվեն օգտատիրոջ տվյալները և դրանց փոխարեն կպահվեն այս սարքում կատարված փոփոխությունները։',
  'guestConflict.useRemote': 'Օգտագործել հաշվի տվյալները',
  'guestConflict.useRemoteHint':
    'այս սարքում չպահպանված փոփոխությունները կջնջվեն։',

  'citations.title': 'Իմ մեջբերումները',
  'citations.emptyBody': 'Այս բաժնում ընդգրկված մեջբերումներ չկան։ ',
  'citations.openTutorial': 'Ինչպե՞ս մեջբերումները տեղադրել էկրանին',
  ...
  'settings.showActionsDesc':
    'Ցույց տալ մեջբերման թարմացման, պահպանման և կիսվելու կոճակները վիջեթի ներքևի հատվածում։',
  ...
  'settings.shareTextFooter':
    'Ուղարկվել է «Մեջբերումներ Աստվածաշնչից» հավելվածից',
