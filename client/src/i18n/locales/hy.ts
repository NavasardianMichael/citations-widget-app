...
export const hy = {
  ...
  "submit.viewProfile": "Դիտել պրոֆիլը",
  ...
  "profile.deleteTitle": "Ջնջել մեջբերումը",
  "profile.deleteBody": "Սա հնարավոր չէ հետարկել։",
  "profile.citationUpdated": "Մեջբերումը թարմացված է։",
  "profile.citationPendingReview": "Փոփոխությունները պահված են։ Մեջբերումը սպասում է վերանայման։",
  "profile.updateCitationFailed": "Չհաջողվեց թարմացնել մեջբերումը",
  "profile.filterAll": "Բոլորը",
  "profile.filterPending": "Սպասող",
  "profile.filterApproved": "Հաստատված",
  "profile.filterRejected": "Մերժված",
  "profile.filterPrivate": "Մասնավոր",
  "profile.mySubmissions": "Իմ ուղարկումները",
  "profile.noSubmissions": "Այս ֆիլտրով ուղարկումներ չկան։",
  "profile.deleteAction": "Ջնջել",
